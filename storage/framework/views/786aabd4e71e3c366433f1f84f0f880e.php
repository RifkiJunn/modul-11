...
<body>
    <div class="container m-5">
        ...
        <div class="list-group list-group-numbered mt-4">
            <a href="<?php echo e(url('/tugascloning')); ?>" class="list-group-item list-group-item-action">
                Tugas cloning Webstite
            </a>
        </div>
    </div>
...
<?php /**PATH D:\MODUL_11&12\bebaa\resources\views/routing.blade.php ENDPATH**/ ?>